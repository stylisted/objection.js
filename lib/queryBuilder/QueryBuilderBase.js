...
class QueryBuilderBase extends QueryBuilderOperationSupport {
  ...
  onConflict() {
    return this.addOperation(new KnexOperation('onConflict'), arguments);
  }
  ...
  withRecursiveWrapped() {
    return this.addOperation(new KnexOperation('withRecursiveWrapped'), arguments);
  }
